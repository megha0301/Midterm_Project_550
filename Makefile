...
output/table_one.rds: code/01_table_one_EL.R data/f75_interim.csv
	Rscript code/01_table_one_EL.R
	
output/boxplot.rds: code/02_boxplot.R data/f75_interim.csv
	Rscript code/02_boxplot.R
	
output/regression_table.rds: code/03_linear_model.R data/f75_interim.csv
